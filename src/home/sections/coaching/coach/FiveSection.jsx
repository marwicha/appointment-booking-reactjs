      ...
      <Grid container spacing={2} textAlign="center" justify="center" alignItems="center">
        ...
        <Grid item xs={12} md={6}>
          <Box display="flex" height="100%">
            <Box my="auto">
              <h3 className={classes.title}> Une séance de coaching avec patrick caillier </h3>


              <p className={classes.p}>

              Vous désirez vous fixer de nouveaux objectifs, ou faire le point dans votre vie.
              Patrick Caillier spécialisé entre autre dans l’accompagnement est là pour vous aider à
              retrouver du sens dans vos projets..</p>
