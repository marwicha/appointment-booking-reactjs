...
const FinalSection = () => {
  ...
  return (
    ...
    <Container maxWidth="lg" className={classes.firstGrid}>
      ...
      <Grid md={12} xs={12} container spacing={0} alignItems="center" justify="center" >
      ...
      Une séance par semaine, avec des exercices quotidiens à pratiquer chez soi de 20 minutes. 
...
<br></br>
Des exercices simples de méditation relaxinésie® stretch (étirements doux), conscience corporelle, Do in (auto massage).
<br></br>
